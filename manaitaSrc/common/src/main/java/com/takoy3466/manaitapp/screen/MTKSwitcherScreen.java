...
public class MTKSwitcherScreen extends Screen implements IDataOperator {
    ...
    private static final Identifier MTK_SWITCHER_LOCATION = new Identifier(ManaitaPPCommon.MOD_ID,"textures/gui/mtk_switcher.png");
    ...
    private static final Component UNDER_TEXT_KEY = Component.literal(ManaitaKey.MTKSwitcherSelectKey.getDefaultKey().getDisplayName().getString()).withStyle(ChatFormatting.AQUA);
    ...
    private void setRange(MTKIcon mtkIcon) {
        ...
        if (minecraft.player != null) {
            ...
            ifPresentSet(stack, CompatData.RANGE_BREAK_DATA, mtkIcon.getModeRange());
        }
    }

    @Override
    public boolean keyPressed(int key1, int key2, int key3) {
        if (key1 == ManaitaKey.MTKSwitcherSelectKey.getDefaultKey().getValue()) {
