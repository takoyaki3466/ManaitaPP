...
public class DataHoverHelper {
    ...
    public static <T, DATA extends AbstractManaitaData<T>> Component hoverDataText(ItemStack stack, DataComponentType<DATA> type, Function<DATA, String> anyText) {
        ...
        if (manaitaData != null) {
            MutableComponent translatable = Component.translatable(stack.getDescriptionId() + "_hover_text");
            return Component.literal(translatable.getString() + anyText.apply(manaitaData));
        }
